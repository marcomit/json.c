 ...
 */
#define VEC_METADATA(v) ((vec_metadata *)((uint8_t *)(v) - sizeof(vec_metadata)))
 ...
 * @endcode
 */
static inline void *veccreate(size_t element_size) {
	size_t total_bytes = sizeof(vec_metadata) + (VEC_DEFAULT_SIZE * element_size);
